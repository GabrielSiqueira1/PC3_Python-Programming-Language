                        ...
                        while not opcao == "v" and not opcao == "q":
                            ...
                            if opcao == "c":
                                ...
                                if opcao == "l":
                                    ...
                                    listar_cc(usuario[chave])
                                    escolha = input(
                                        f"Das contas listadas, digite o número da conta que deseja escolher? "
                                    )
                                    ...
                                    while not opcao == "v" and not opcao == "q":
                                        ...
                                        if opcao == "d":
                                            valor_deposito = input(
                                                f"Quanto deseja depositar? "
                                            )
                                            (
                                                usuario[chave]["cc"][escolha]["saldo"],
                                                extrato,
                                            ) = deposito(
                                                usuario[chave]["cc"][escolha]["saldo"],
                                                valor_deposito,
                                            ...
                                            print(
                                                f'Seu saldo atual é: R${usuario[chave]["cc"][escolha]["saldo"]:.2f}'
                                            )
                                            ...
                                            saldo, extrato, numero_saques = sacar(
                                                saldo=usuario[chave]["cc"][escolha][
                                                    "saldo"
                                                ],
                                                valor_saque=valor_sacar,
                                                extrato=extrato,
